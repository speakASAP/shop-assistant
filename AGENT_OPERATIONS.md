...
Read repository-local instructions and planning sources first, including any `AGENTS.md`, `TASKS.md`, `STATE.json`, `docs/orchestrator/*`, `docs/*`, or project-specific equivalents.
...
Use `docs/orchestrator/VALIDATION_DEBT.md`, `docs/VALIDATION_DEBT.md`, or the nearest repo-standard ledger to record known out-of-scope validation failures.
