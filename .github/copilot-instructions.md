# Copilot Instructions — `shop-assistant`
...
- **Authoritative path**: `/home/ssf/Documents/Github/shop-assistant` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/shop-assistant.git`, branch `main`.
