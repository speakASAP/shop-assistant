...
| payments | payments-microservice | required | SA-G8-B2 billing/entitlement via Prisma checkout models and a runtime-gated payments client. Machine calls use Auth-issued pair RS256 Bearer per [`SERVICE_IDENTITY_CONSUMER_STANDARD.md`](../../../auth-microservice/docs/SERVICE_IDENTITY_CONSUMER_STANDARD.md) (not API-key / `X-API-Key`). |
