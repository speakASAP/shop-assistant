...
- Read `AGENTS.md`, `docs/PRE_CODING_GATE.md`, `docs/11_tasks/SA-G7-T1.md`, `docs/21_execution_plans/EP-SA-G7-FRONTEND.md`, and `docs/13_context_packages/CP-SA-G7-FRONTEND.md` before source edits.
...
Append validation evidence to `docs/12_validation/VAL-SA-G7-FRONTEND.md`, append task status evidence to `TASKS.md`, and update `STATE.json` with the current goal state and next focus.
