...
status: draft
source_task: docs/intent-preservation/tasks/SA-G2-T1.md
...
- Vision: docs/intent-preservation/01_vision/VISION.md
- Goal Impact: docs/intent-preservation/22_goal_impact/GOAL-SA-G2.md
- System: docs/intent-preservation/04_systems/SYS-001-shop-assistant.md
- Feature: docs/intent-preservation/10_features/FEAT-004-leads-legal-operations.md
- Task: docs/intent-preservation/tasks/SA-G2-T1.md
...
Read-only inspection targets: BUSINESS.md, SYSTEM.md, README.md, TASKS.md, STATE.json, public/, src/auth/, src/admin/, src/leads/, src/sessions/, scripts/, k8s/, docs/intent-preservation/.

Allowed write targets: docs/intent-preservation/validation-reports/VAL-SA-G2-LEGAL-PRIVACY-AUDIT.md, TASKS.md, STATE.json.
...
Shared contracts: BUSINESS.md, README.md, SYSTEM.md, docs/intent-preservation/README.md, TRACEABILITY_MATRIX.md, public legal pages, and Auth/RBAC ownership boundaries. Merge order: docs audit, public/legal audit, protected surface audit, integration summary.
