...
upstream:
  - docs/intent-preservation/tasks/SA-DOCS-T1.md
downstream:
  - AGENTS.md
  - TASKS.md
  - STATE.json
...
Created required artifacts under `docs/intent-preservation/` and updated `AGENTS.md`.
...
Context package: docs/intent-preservation/README.md and source docs
...
Treat the Shop Assistant IPS pack as active. Future implementation work should start by reading `docs/intent-preservation/README.md`, selecting a task, completing `PRE_CODING_GATE.md`, and updating the relevant validation report before completion.
