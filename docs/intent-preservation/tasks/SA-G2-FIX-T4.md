...
| Integration evidence | complete | Orchestrator | Record task, validation, and state evidence. | docs/intent-preservation/validation-reports/VAL-SA-G2-LEGAL-PRIVACY-AUDIT.md, TASKS.md, STATE.json | JSON parse and final git status. |
