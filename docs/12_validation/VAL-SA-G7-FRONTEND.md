...
Execution plan: `docs/21_execution_plans/EP-SA-G7-FRONTEND.md`
Context package: `docs/13_context_packages/CP-SA-G7-FRONTEND.md`
Coding prompt: `docs/14_prompts/PROMPT-SA-G7-FRONTEND.md`
...
- Added `docs/16_operations/SA-G7-FRONTEND-ROLLOUT-RUNBOOK.md`.
...
```bash
ssh ssf@192.168.88.53 'cd /home/ssf/Documents/Github/shop-assistant && test -f docs/16_operations/SA-G7-FRONTEND-ROLLOUT-RUNBOOK.md && test -x scripts/build-and-push-image.sh && test -x scripts/deploy.sh && test -x scripts/post-deploy-check.sh && test -x scripts/sa-g7-live-smoke.sh && bash -n scripts/build-and-push-image.sh && bash -n scripts/deploy.sh && bash -n scripts/post-deploy-check.sh && bash -n scripts/sa-g7-live-smoke.sh && npm run build && rg -n "Source fingerprint|EXPECTED_SOURCE_FINGERPRINT|Token-Backed Smoke|Browser Verification|Failure Diagnostics|Evidence To Record" docs/16_operations/SA-G7-FRONTEND-ROLLOUT-RUNBOOK.md'
```
...
- Updated `docs/16_operations/SA-G7-FRONTEND-ROLLOUT-RUNBOOK.md` to use the preflight script before owner-approved build/push/deploy.
...
- Updated `docs/16_operations/SA-G7-FRONTEND-ROLLOUT-RUNBOOK.md` to include the source audit in preflight.
...
- Updated `docs/16_operations/SA-G7-FRONTEND-ROLLOUT-RUNBOOK.md` with browser verification commands.
...
- Updated `docs/16_operations/SA-G7-FRONTEND-ROLLOUT-RUNBOOK.md` to prefer token files over raw token environment values.
...
Result: pass. Downstream SA-G7 Intent Preservation artifacts were aligned with the closed umbrella task after integration commit `0cdb05e` closed `TASKS.md`, `STATE.json`, and `docs/11_tasks/SA-G7-T1.md`.
