# Validation Report: IPS Structure Installation
    ...
    upstream:
      - docs/21_execution_plans/EP-SA-DOCS-T1.md
    downstream: []
    related_adrs: []
...
Use docs/00_constitution/CONSTITUTION.md, docs/01_vision/VISION.md, docs/PRE_CODING_GATE.md, and docs/21_execution_plans/ before future coding. Resolve backlog [MISSING: ...] markers only after owner selects the concrete work scope and approves redacted evidence sources.
