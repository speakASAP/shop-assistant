...
Execution plan: docs/21_execution_plans/EP-SA-G2-LEGAL-PRIVACY-AUDIT.md
Context package: docs/13_context_packages/CP-SA-G2-LEGAL-PRIVACY-AUDIT.md
Coding prompt: docs/14_prompts/PROMPT-SA-G2-LEGAL-PRIVACY-AUDIT.md
...
1. Root-level TRACEABILITY_MATRIX.md and PRE_CODING_GATE.md are missing, while canonical active equivalents exist under docs/.
...
- README.md
- docs/16_operations/SA-G7-FRONTEND-ROLLOUT-RUNBOOK.md
