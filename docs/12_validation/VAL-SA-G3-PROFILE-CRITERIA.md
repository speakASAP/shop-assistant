...
Execution plan: docs/21_execution_plans/EP-SA-G3-PROFILE-CRITERIA.md
Context package: docs/13_context_packages/CP-SA-G3-PROFILE-CRITERIA.md
Coding prompt: docs/14_prompts/PROMPT-SA-G3-PROFILE-CRITERIA.md
