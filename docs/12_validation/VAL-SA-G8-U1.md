...
Execution plan: `docs/21_execution_plans/EP-SA-G8-SALES-READINESS.md`
Context package: `docs/16_operations/UX-SA-G4-T1-2026-06-21.md`
Coding prompt: `docs/14_prompts/PROMPT-SA-G8-SALES-READINESS.md`
