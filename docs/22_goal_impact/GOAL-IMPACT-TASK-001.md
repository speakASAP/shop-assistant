# Goal Impact: Shop Assistant IPS adoption bootstrap
...
Bring shop-assistant into full IPS adoption compliance, matching the standard already applied to cv-tuning, runlayer, and wisdom-quotes.

## contribution

Completing the adoption profile makes shop-assistant's privacy/search-fabrication constraints, gated-billing boundary, and integration decisions explicit and machine-checkable, reducing drift risk as the owner-gated checkout smoke is eventually completed.

## success metric

- IPS planning validator passes for shop-assistant with zero errors
