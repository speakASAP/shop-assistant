...
upstream:
  ...
  - docs/16_operations/UX-SA-G4-T1-2026-06-21.md
  - docs/21_execution_plans/EP-SA-HOSTED-AUTH-VERIFICATION-2026-06-24.md
downstream:
...
Coding Prompt: See `docs/14_prompts/PROMPT-SA-G8-SALES-READINESS.md`.
